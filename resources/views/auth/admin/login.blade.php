                  ...
                  <div class="panel panel-info">
                    ...
                    <tr>
                        <td >
                            ...
                            <tr class="btn-info" >
                                <td style="color: white;" class="text-center"><h1 style="color: white;"><b>Admin Login</b></h1>
                    ...
                    <div class="panel-body">
                           <form method="POST" action="{{ route('admin.login.submit') }}">
                                ...
                                <button type="submit" name="submit" class="btn btn-info btn-block"><i class="fa fa-key"></i> <b>Login Now</b></button>
                            </form>
                      </div>
                      <div class="panel-footer text-center">
                          <table>
                              <tr style="font-weight: bold">
                                  ...
                                  <td>
                                      <a href="{{ route('admin.register') }}">Not register yet?</a>
                                  </td>
                              </tr>
                          </table>
                      </div>
